    ...
    class BaseFetchEnv(RobotEnvClass):
        ...
        def __init__(
            ...
            **kwargs
            ...
            # jesnk
            #self.observation_space = spaces.Box(low=np.array([-10, 0, -5]), high=np.array([10, 50, 5]), dtype=np.float32)
        ...
        def _get_obs(self):
            ...
            #jesnk : for investigate observation space
            '''
            obs_prev = [
                    grip_pos,
                    object_pos.ravel(),
            ...
            obs_lens = [len(obs) for obs in obs_prev]
            print(obs_lens)  
